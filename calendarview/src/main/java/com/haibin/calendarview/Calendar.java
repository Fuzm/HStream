...
public class Calendar implements Serializable {
    ...
    public void setTime(Date date) {
        ...
        setDay(cal.get(java.util.Calendar.DATE));
    }
    ...
    public int hashCode() {
        int hashResult = 1;
        hashResult = (hashResult + Integer.valueOf(year).hashCode()
                + Integer.valueOf(month).hashCode() + Integer.valueOf(day).hashCode()) * PRIME;
        return hashResult;
    }

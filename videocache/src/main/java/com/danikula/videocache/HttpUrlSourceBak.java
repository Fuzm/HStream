 ...
 */
public class HttpUrlSourceBak implements Source {

    private static final Logger LOG = LoggerFactory.getLogger("HttpUrlSourceBak");
    ...
    public HttpUrlSourceBak(String url) {
        this(url, SourceInfoStorageFactory.newEmptySourceInfoStorage());
    }

    public HttpUrlSourceBak(String url, SourceInfoStorage sourceInfoStorage) {
        this(url, sourceInfoStorage, new EmptyHeadersInjector());
    }

    public HttpUrlSourceBak(String url, SourceInfoStorage sourceInfoStorage, HeaderInjector headerInjector) {
    ...
    public HttpUrlSourceBak(HttpUrlSourceBak source) {
    ...
    public String toString() {
        return "HttpUrlSourceBak{sourceInfo='" + sourceInfo + "}";
    }
}
